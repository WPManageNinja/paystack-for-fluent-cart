...
Create a JavaScript file to handle the frontend interactions:
...
class WebhookHandler
{
    ...
    private function handlePaymentSucceeded($payment_data)
    {
        ...
        if ($transaction && $transaction->status !== Status::PAID) {
            ...
            do_action('fluent_cart/payment_success', $transaction->order, $transaction);
        }
    }
